...
function wpfcas_setup_post_types() {
	...
	$wpfcas_labels =  apply_filters( 'wpfcas_labels', array(
					...
					'set_featured_image'		=> __( 'Set Featured Content Image', 'wp-blog-and-widgets' ),
					'featured_image'			=> __( 'Featured Content Image', 'wp-blog-and-widgets' ),
					'remove_featured_image'		=> __( 'Remove Featured Content Image', 'wp-blog-and-widgets' ),
					'use_featured_image'		=> __( 'Use as Featured Content image', 'wp-blog-and-widgets' ),
				));
